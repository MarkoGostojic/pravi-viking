    ...
    <UForm :state="state" :schema="schema" ref="form" @submit="save">
      <UCard>
        ...
        >
          <UInput
            type="number"
            placeholder="upišite Matični broj radnika"
            v-model="state.maticni"
          />
        </UFormGroup>
        <UFormGroup
        ...
        >
          <USelect
            ...
            :options="['dispečer transporta', 'šef transporta', 'referent za obradu taho listića','referent transporta']"
            v-model="state.kategorija"
          />
        </UFormGroup>
        <UFormGroup
          label="Koeficijent radnika"
          required
          name="koeficijent"
          class="mb-4"
        >
          <UInput
            type="number"
            placeholder="upišite koeficijent radnika"
            v-model="state.koeficijent"
          />
        </UFormGroup>
        <UFormGroup
